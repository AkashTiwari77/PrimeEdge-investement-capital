...
const EMAIL_TRANSPORT_PORT = process.env.EMAIL_PORT
...
function createMailerTransporter() {
  ...
  if (
    EMAIL_TRANSPORT_HOST.includes("gmail.com") ||
    EMAIL_TRANSPORT_USER.endsWith("@gmail.com")
  ) {
...
async function sendContactNotification(lead) {
  ...
  if (!transporter) {
    return {
      sent: false,
      warning:
        "Email transport is not configured. Set EMAIL_USER and EMAIL_PASS environment variables.",
    };
  }
...
export const routes = {
  ...
  // ✅ FIXED CONTACT FORM SUBMISSION - fire and forget email
  "/api/contact": async (req, res, origin) => {
    ...
    try {
      ...
      sendContactNotification(lead).catch((err) =>
      ...
      try {
        ...
        if (!userId || !type) {
          return sendJson(
            res,
            400,
            { success: false, error: "UserId and type required" },
            origin,
          );
        }
  ...
  "/api/subscription": async (req, res, origin) => {
    if (req.method === "POST") {
      try {
        const { userId, plan, amount, billingCycle } =
        ...
        if (!userId || !plan || !amount) {
          return sendJson(
            res,
            400,
            { success: false, error: "UserId, plan, and amount required" },
            origin,
          );
        }
  ...
  "/api/market-category": async (req, res, origin) => {
    ...
    const categories = {
      delivery: [
        {
          ...
          detail: "Energy, retail, telecom",
        },
        {
          symbol: "HDFCBANK.NS",
          name: "HDFC Bank",
          detail: "Private banking leader",
        },
        { symbol: "TCS.NS", name: "TCS", detail: "Large-cap IT services" },
        {
          symbol: "ICICIBANK.NS",
          name: "ICICI Bank",
          detail: "Retail and corporate banking",
        },
        {
          symbol: "INFY.NS",
          name: "Infosys",
          detail: "IT consulting and digital",
        },
        {
          symbol: "BHARTIARTL.NS",
          name: "Bharti Airtel",
          detail: "Telecom and digital services",
        },
        {
          symbol: "LT.NS",
          name: "Larsen & Toubro",
          detail: "Infrastructure and engineering",
        },
      ...
      intraday: [
        {
          symbol: "^NSEBANK",
          name: "Nifty Bank",
          detail: "High liquidity index basket",
        },
        {
          symbol: "RELIANCE.NS",
          name: "Reliance Industries",
          detail: "Active large-cap volumes",
        },
        {
          symbol: "HDFCBANK.NS",
          name: "HDFC Bank",
          detail: "Banking momentum trades",
        },
        {
          symbol: "ICICIBANK.NS",
          name: "ICICI Bank",
          detail: "Frequent intraday swings",
        },
        { symbol: "SBIN.NS", name: "SBI", detail: "High retail participation" },
        {
          symbol: "TATAMOTORS.NS",
          name: "Tata Motors",
          detail: "Auto sector volatility",
        },
        { symbol: "INFY.NS", name: "Infosys", detail: "IT sector liquidity" },
        {
          symbol: "AXISBANK.NS",
          name: "Axis Bank",
          detail: "Banking breakout setups",
        },
        {
          symbol: "ADANIENT.NS",
          name: "Adani Enterprises",
          detail: "Momentum-focused stock",
        },
        {
          symbol: "BAJFINANCE.NS",
          name: "Bajaj Finance",
          detail: "Finance sector moves",
        },
      ],
      fo: [
        {
          symbol: "^NSEI",
          name: "Nifty 50",
          detail: "Index futures and options",
        },
        {
          symbol: "^NSEBANK",
          name: "Bank Nifty",
          detail: "Banking index derivatives",
        },
        {
          symbol: "RELIANCE.NS",
          name: "Reliance Industries",
          detail: "Stock futures liquidity",
        },
        {
          symbol: "HDFCBANK.NS",
          name: "HDFC Bank",
          detail: "Options-heavy counter",
        },
        {
          symbol: "ICICIBANK.NS",
          name: "ICICI Bank",
          detail: "Active option chain",
        },
        {
          symbol: "TATASTEEL.NS",
          name: "Tata Steel",
          detail: "Commodity-linked moves",
        },
        {
          symbol: "TATAMOTORS.NS",
          name: "Tata Motors",
          detail: "Auto derivatives interest",
        },
        { symbol: "INFY.NS", name: "Infosys", detail: "IT sector hedging" },
        {
          symbol: "AXISBANK.NS",
          name: "Axis Bank",
          detail: "Banking F&O activity",
        },
        {
          symbol: "BAJFINANCE.NS",
          name: "Bajaj Finance",
          detail: "Premium finance stock",
        },
      ],
      "mutual-fund": [
        {
          symbol: "HDFCAMC.NS",
          name: "HDFC AMC",
          detail: "Listed asset management company",
        },
        {
          symbol: "NAM-INDIA.NS",
          name: "Nippon India AMC",
          detail: "Retail-focused asset manager",
        },
        {
          symbol: "ABSLAMC.NS",
          name: "Aditya Birla Sun Life AMC",
          detail: "Mutual fund asset manager",
        },
        {
          symbol: "UTIAMC.NS",
          name: "UTI AMC",
          detail: "Legacy asset manager",
        },
        {
          symbol: "MFSL.NS",
          name: "Max Financial",
          detail: "Financial services market proxy",
        },
        {
          symbol: "SBILIFE.NS",
          name: "SBI Life",
          detail: "SBI group financial market proxy",
        },
        {
          symbol: "ICICIPRULI.NS",
          name: "ICICI Prudential Life",
          detail: "ICICI group financial market proxy",
        },
        {
          symbol: "KOTAKBANK.NS",
          name: "Kotak Bank",
          detail: "Kotak group financial market proxy",
        },
      ],
      banking: [
        {
        ...
        { symbol: "SBIN.NS", name: "SBI", detail: "Public sector banking" },
        {
          symbol: "AXISBANK.NS",
          name: "Axis Bank",
          detail: "Large private bank",
        },
        {
          symbol: "KOTAKBANK.NS",
          name: "Kotak Bank",
          detail: "Private banking and wealth",
        },
        {
          symbol: "INDUSINDBK.NS",
          name: "IndusInd Bank",
          detail: "Private sector banking",
        },
        {
          symbol: "BANKBARODA.NS",
          name: "Bank of Baroda",
          detail: "Public sector banking",
        },
      ...
      "it-sector": [
        ...
        },
        {
          symbol: "HCLTECH.NS",
          name: "HCL Tech",
          detail: "Enterprise technology services",
        },
        {
          symbol: "WIPRO.NS",
          name: "Wipro",
          detail: "IT services and consulting",
        },
        {
          symbol: "TECHM.NS",
          name: "Tech Mahindra",
          detail: "Technology and telecom services",
        },
        {
          symbol: "LTIM.NS",
          name: "LTIMindtree",
          detail: "Digital transformation services",
        },
        {
          symbol: "PERSISTENT.NS",
          name: "Persistent",
          detail: "Software engineering services",
        },
        {
          symbol: "MPHASIS.NS",
          name: "Mphasis",
          detail: "IT and cloud services",
        },
      ],
      auto: [
        {
          symbol: "MARUTI.NS",
          name: "Maruti",
          detail: "Passenger vehicle leader",
        },
        {
          symbol: "TATAMOTORS.NS",
          name: "Tata Motors",
          detail: "Auto and EV momentum",
        },
        {
          symbol: "M&M.NS",
          name: "Mahindra & Mahindra",
          detail: "SUVs, tractors, and mobility",
        },
        {
          symbol: "BAJAJ-AUTO.NS",
          name: "Bajaj Auto",
          detail: "Two-wheeler and export strength",
        },
        {
          symbol: "EICHERMOT.NS",
          name: "Eicher Motors",
          detail: "Premium motorcycle segment",
        },
        {
          symbol: "HEROMOTOCO.NS",
          name: "Hero MotoCorp",
          detail: "Two-wheeler manufacturer",
        },
        {
          symbol: "TVSMOTOR.NS",
          name: "TVS Motor",
          detail: "Two and three-wheeler maker",
        },
        {
          symbol: "ASHOKLEY.NS",
          name: "Ashok Leyland",
          detail: "Commercial vehicles",
        },
      ],
      pharma: [
        {
          symbol: "SUNPHARMA.NS",
          name: "Sun Pharma",
          detail: "Large pharmaceutical company",
        },
        {
          symbol: "DRREDDY.NS",
          name: "Dr Reddy's",
          detail: "Generic and specialty pharma",
        },
        {
          symbol: "CIPLA.NS",
          name: "Cipla",
          detail: "Healthcare and respiratory focus",
        },
        {
          symbol: "DIVISLAB.NS",
          name: "Divi's Labs",
          detail: "API and pharma ingredients",
        },
        {
          symbol: "APOLLOHOSP.NS",
          name: "Apollo Hospitals",
          detail: "Healthcare services leader",
        },
        {
          symbol: "LUPIN.NS",
          name: "Lupin",
          detail: "Global pharmaceutical company",
        },
        {
          symbol: "AUROPHARMA.NS",
          name: "Aurobindo Pharma",
          detail: "Pharma manufacturing",
        },
        {
          symbol: "ZYDUSLIFE.NS",
          name: "Zydus Life",
          detail: "Healthcare and pharma products",
        },
      ],
      bitcoin: [
        { symbol: "BTC-USD", name: "Bitcoin", detail: "Largest crypto asset" },
        {
          symbol: "ETH-USD",
          name: "Ethereum",
          detail: "Smart contract network",
        },
        {
          symbol: "USDT-USD",
          name: "Tether",
          detail: "USD stablecoin liquidity",
        },
        { symbol: "BNB-USD", name: "BNB", detail: "Exchange ecosystem token" },
        {
          symbol: "SOL-USD",
          name: "Solana",
          detail: "High-throughput blockchain",
        },
        ...
        { symbol: "USDC-USD", name: "USDC", detail: "Regulated stablecoin" },
        {
          symbol: "DOGE-USD",
          name: "Dogecoin",
          detail: "High retail attention",
        },
        {
          symbol: "ADA-USD",
          name: "Cardano",
          detail: "Proof-of-stake blockchain",
        },
    ...
    if (!symbols) {
      return sendJson(
        res,
        400,
        { success: false, error: "Unknown market category" },
        origin,
      );
    }
